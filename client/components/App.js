            ...
            {this.state.data.map(function(exp) {
              return (
                <tr>
                  ...
                  <td key={exp.description} className="desc-col">
                    {exp.description}
                  </td>
                  <td key={exp.amount} className="button-col">
                    {exp.amount}
                  </td>
                  <td key={exp.month} className="button-col">
                    {exp.month}
                  </td>
                  <td key={exp.year} className="button-col">
                    {exp.year}
                  </td>
